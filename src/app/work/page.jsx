...
const featuredProjects = [
  ...
  },
  {
    ...
    description:
      'Developed a full-stack trading journal platform using Next.js with Server-Side Rendering, featuring interactive data visualizations through recharts for trading metrics. Implemented secure user authentication and row-level security using Supabase, with real-time data updates for trade entries.',
  ...
  },
  {
    ...
    title: 'LottoToday',
    description:
      'High-performance lottery results platform featuring automated data collection through Cheerio web scraping and real-time number verification. Created a comprehensive content system for lottery guides and claiming procedures, achieving exceptional Lighthouse scores (100 Performance, 100 SEO, 93 Accessibility).',
    image: '/assets/images/lottotoday.png',
    demoLink: 'https://lottotoday.ph',
    techStack: [
      'Next.js',
      'TypeScript',
      'Tailwind CSS',
  ...
  },
  {
    ...
    title: 'PhilDocGuide',
    description:
      'A streamlined web platform that simplifies Philippine government document applications. Features include interactive checklists for requirements tracking, real-time progress saving, and comprehensive guides for various government documents.',
    image: '/assets/images/checkph.png',
    demoLink: 'https://check-ph.vercel.app/',
    techStack: [
      'Next.js',
      'TypeScript',
      'Tailwind CSS',
